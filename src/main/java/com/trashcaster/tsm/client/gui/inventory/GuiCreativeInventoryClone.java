...
public class GuiCreativeInventoryClone extends InventoryEffectRenderer
{
    ...
    public GuiCreativeInventoryClone(EntityPlayer p_i1088_1_)
    {
        super(new GuiCreativeInventoryClone.ContainerCreative(p_i1088_1_));
    ...
    public void updateScreen()
    {
        ...
        {
            this.mc.displayGuiScreen(new GuiInventoryExpanded(this.mc.thePlayer));
        }
        ...
        else
        {
            ...
            else
            {
                ...
                if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex())
                {
                    ...
                    {
                        this.mc.thePlayer.inventoryContainer.slotClick(slotIn == null ? slotId : ((GuiCreativeInventoryClone.CreativeSlot)slotIn).slot.slotNumber, clickedButton, clickType, this.mc.thePlayer);
    ...
    {
        GuiCreativeInventoryClone.ContainerCreative containercreative = (GuiCreativeInventoryClone.ContainerCreative)this.inventorySlots;
    ...
    private void updateFilteredItems(GuiCreativeInventoryClone.ContainerCreative containercreative)
    {
        Iterator iterator;
    ...
    private boolean needsScrollBars()
    {
        ...
        return selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((GuiCreativeInventoryClone.ContainerCreative)this.inventorySlots).func_148328_e();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
    {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory)
        {
            ...
            {
                GuiCreativeInventoryClone.CreativeSlot creativeslot = new GuiCreativeInventoryClone.CreativeSlot((Slot)container.inventorySlots.get(j), j);
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        {
            int j = ((GuiCreativeInventoryClone.ContainerCreative)this.inventorySlots).itemList.size() / 9 - 5 + 1;
            ...
            ((GuiCreativeInventoryClone.ContainerCreative)this.inventorySlots).scrollTo(this.currentScroll);
        }
    }
    ...
    static class ContainerCreative extends Container
        {
            ...
            public ContainerCreative(EntityPlayer p_i1086_1_)
            {
                ...
                for (i = 0; i < 5; ++i)
                {
                    for (int j = 0; j < 9; ++j)
                    {
                        this.addSlotToContainer(new Slot(GuiCreativeInventoryClone.field_147060_v, i * 9 + j, 9 + j * 18, 18 + i * 18));
                    }
                }
            ...
            public void scrollTo(float p_148329_1_)
            {
                ...
                for (int k = 0; k < 5; ++k)
                {
                    for (int l = 0; l < 9; ++l)
                    {
                        ...
                        {
                            GuiCreativeInventoryClone.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)this.itemList.get(i1));
                        }
                        else
                        {
                            GuiCreativeInventoryClone.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)null);
                        }
                    }
                }
            }
